...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup(
            reply_keyboard, resize_keyboard=True, one_time_keyboard=True, input_field_placeholder="Boy or Girl?"
        ),
    )
...
async def gender(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup(
            keyboard=[["/skip"]], resize_keyboard=True, one_time_keyboard=True,
            input_field_placeholder="Send a photo of yourself"
        )
    )
...
async def photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logger.info("Photo of %s: %s", user.username, "user_photo.jpg")
    await update.message.reply_text(
...
async def location(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup(
            keyboard=[["/skip"]], resize_keyboard=True, one_time_keyboard=True,
            input_field_placeholder="Send a location of yourself"
        )
    )
